...
export default function ProhectForm({ onClose }: IsClose) {
    ...
    const handleSubmit = () => {
        ...
        const updatedWorkspace: workspace = {
            ...
            project_summary: "", // 요약은 추후 AI가 생성
            project_features: JSON.stringify(features), // 문자열로 저장
        };
    ...
    return (
        <div className="form-container">
            ...
            <div>
                <label className="form-label">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M480-80q-26 0-47-12.5T400-126q-33 0-56.5-23.5T320-206v-142q-59-39-94.5-103T190-590q0-121 84.5-205.5T480-880q121 0 205.5 84.5T770-590q0 77-35.5 140T640-348v142q0 33-23.5 56.5T560-126q-12 21-33 33.5T480-80Zm-80-126h160v-36H400v36Zm0-76h160v-38H400v38Zm-8-118h58v-108l-88-88 42-42 76 76 76-76 42 42-88 88v108h58q54-26 88-76.5T690-590q0-88-61-149t-149-61q-88 0-149 61t-61 149q0 63 34 113.5t88 76.5Zm88-162Zm0-38Z" /></svg>
                    <p>메인 기능</p>
                </label>
                ...
                <button className="form-add-button" onClick={addFeature}>+ 메인 기능 추가</button>
            </div>
            ...
            <div>
                ...
                <button className="form-add-button" onClick={addStack}>+ 기술 스택 추가</button>
            </div>
            ...
            <div className="form-submit-wrapper">
                <button disabled={isFormIncomplete} className="form-submit-button" onClick={handleSubmit}>제출하기</button>
            </div>
        </div>
    );
} 